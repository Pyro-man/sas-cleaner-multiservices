# Script pour ajouter les liens Transport et Déménagement aux menus des autres pages - VERSION CORRIGÉE
...
function Process-File {
    ...
    # Pattern pour trouver la fin du menu (avant la fermeture de </ul>)
